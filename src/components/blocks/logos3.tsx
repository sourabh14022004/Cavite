...
const Logos3 = ({
  ...
  return (
    <section className="py-24 sm:py-32 w-full snap-start [scroll-snap-stop:always]">
      <div className="container flex flex-col items-center text-center mx-auto px-4">
        <h2 className="mb-6 text-xl font-semibold text-neutral-400 tracking-wide uppercase sm:text-2xl">
          {heading}
        </h2>
      </div>
      <div className="pt-10 md:pt-16 lg:pt-20">
        <div className="relative mx-auto flex items-center justify-center lg:max-w-6xl w-full">
          <Carousel
            opts={{ loop: true }}
          ...
          >
            <CarouselContent className="ml-0 w-full">
              {logos.map((logo) => (
                ...
                >
                  <div className="mx-6 flex shrink-0 items-center justify-center opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-300">
                    <div>
                      <img
                        src={logo.image}
          ...
          <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-black via-black/80 to-transparent z-10"></div>
          <div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-black via-black/80 to-transparent z-10"></div>
        </div>
      </div>
    </section>
  );
